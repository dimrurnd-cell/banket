...
ASSET_BASE=https://donexpocentre.ru/static/banket/assets/ python3 _src/build_tilda.py
```
...
`https://donexpocentre.ru/static/banket/assets/gallery/`.
...
|-------|----------|-------|--------------|
| `/` | Банкетный зал в Ростове-на-Дону на 50–2 500 … | glavnaya | 30 КБ |
...
| `/zaly/vystavochny` | Зал на 1000–2500 человек в Ростове-на-Дону |… | zaly-vystavochny | 7 КБ |
...
| `/galereya` | Фото залов и мероприятий в Ростове-на-Дону |… | galereya | 9 КБ |
